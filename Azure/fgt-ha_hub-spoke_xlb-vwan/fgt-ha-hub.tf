...
module "fgt_hub_config" {
  ...
  source     = "jmvigueras/ftnt-azure-modules/azure//modules/fgt-config"
  version    = "0.0.1"
...
module "fgt_hub" {
  ...
  source     = "jmvigueras/ftnt-azure-modules/azure//modules/fgt-ha"
  version    = "0.0.1"
...
module "fgt_hub_vnet" {
  source  = "jmvigueras/ftnt-azure-modules/azure//modules/vnet-fgt"
  version = "0.0.1"
...
module "xlb" {
  ...
  source     = "jmvigueras/ftnt-azure-modules/azure//modules/xlb"
  version    = "0.0.1"
...
module "vwan" {
  ...
  source     = "jmvigueras/ftnt-azure-modules/azure//modules/vwan"
  version    = "0.0.1"
...
module "vhub_vnet-spoke" {
  ...
  source  = "jmvigueras/ftnt-azure-modules/azure//modules/vnet-spoke"
  version = "0.0.1"
...
module "rs" {
  ...
  source     = "jmvigueras/ftnt-azure-modules/azure//modules/routeserver"
  version    = "0.0.1"
