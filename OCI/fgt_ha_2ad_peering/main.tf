...
// Create FGT config
module "fgt_config" {
  source  = "jmvigueras/ftnt-oci-modules/oci//modules/fgt_config"
  version = "0.0.1"
...
module "fgt" {
  source  = "jmvigueras/ftnt-oci-modules/oci//modules/fgt_ha"
  version = "0.0.1"
...
module "fgt_lpg" {
  source  = "jmvigueras/ftnt-oci-modules/oci//modules/lpg"
  version = "0.0.1"
...
module "spoke_vcn" {
  source  = "jmvigueras/ftnt-oci-modules/oci//modules/vcn_spoke_peer"
  version = "0.0.1"
...
module "spoke_vm" {
  source  = "jmvigueras/ftnt-oci-modules/oci//modules/vm"
  version = "0.0.1"
